...
const BentoCard = ({
  ...
  >
    ...
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 lg:group-hover:-translate-y-10">
      <Icon className="h-10 w-10 origin-left transform-gpu text-[#D97757] transition-all duration-300 ease-in-out group-hover:scale-75" />
      <h3 className="text-xl font-bold text-[#141413] dark:text-neutral-300">
        {name}
      </h3>
      <p className="max-w-lg text-[#141413]/60 font-medium leading-relaxed">
        {description}
      </p>
    </div>
    ...
    >
      <Button
        ...
        asChild
        size="sm"
        className="pointer-events-auto p-0 text-[#D97757]"
      >
        <a href={href}>
          {cta}
